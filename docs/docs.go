...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/shops/businesses/branches/close-temporarily/{branchId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.CloseTemporarilyBranchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/businesses/branches/open/{branchId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.OpenBranchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/revisions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Update Admin Revision Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.UpdateAdminRevisionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.UpdateAdminRevisionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Close Admin Revision Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.CloseAdminRevisionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.CloseAdminRevisionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/revisions/branches": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Open Admin Revision To Branch Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBranchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBranchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/revisions/businesses": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "tags": [
                    "v1 shops revisions businesses"
                ],
                "summary": "Open an admin revision to a business",
                "parameters": [
                    {
                        "description": "Open Admin Revision To Business Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBusinessRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBusinessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/revisions/businesses/products": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Open Admin Revision To Business Product Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBusinessProductRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToBusinessProductResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/shops/revisions/products": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Open Admin Revision To Product Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToProductRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/shop.OpenAdminRevisionToProductResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "shop.CloseAdminRevisionRequest": {
            "type": "object",
            "properties": {
                "admin_revision_id": {
                    "type": "string"
        ...
        "shop.CloseAdminRevisionResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.CloseTemporarilyBranchResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.OpenAdminRevisionToBranchRequest": {
            "type": "object",
            "properties": {
                "admin_revision": {
                    "$ref": "#/definitions/shop.OpenAdminRevision"
                },
                "branch_id": {
                    "type": "string"
                }
        ...
        "shop.OpenAdminRevisionToBranchResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.OpenAdminRevisionToBusinessProductRequest": {
            "type": "object",
            "properties": {
                "admin_revision": {
                    "$ref": "#/definitions/shop.OpenAdminRevision"
        ...
        "shop.OpenAdminRevisionToBusinessProductResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.OpenAdminRevisionToBusinessRequest": {
            "type": "object",
            "properties": {
                "business_id": {
                    "type": "string"
        ...
        "shop.OpenAdminRevisionToBusinessResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.OpenAdminRevisionToProductRequest": {
            "type": "object",
            "properties": {
                "admin_revision": {
                    "$ref": "#/definitions/shop.OpenAdminRevision"
        ...
        "shop.OpenAdminRevisionToProductResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "shop.UpdateAdminRevisionRequest": {
            "type": "object",
            "properties": {
                "admin_revision_id": {
                    "type": "string"
        ...
        "shop.UpdateAdminRevisionResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
